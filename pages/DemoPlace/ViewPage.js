...
export default class DemoPlaceViewPage extends LitElement {
  ...
  constructor() {
    ...
    this.entity = {
      name: "DemoPlace name",
      description: "DemoPlace description",
      childEntities: [
        {
          name: "Child Entity",
...
customElements.define("demo-place-view-page", DemoPlaceViewPage);
